...
const Args =  require('commander')
    ...
    .option('-c, --canacl <string>, AWS S3 Canned ACL (private, public-read, public-read-write, etc...)')
    .option('-u, --url <string>, host + path Url to build the canonical chart link with')
